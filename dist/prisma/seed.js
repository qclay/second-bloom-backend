    ...
    const products = await Promise.all([
        prisma.product.create({
            data: {
                ...
                description: 'Beautiful fresh red roses bouquet perfect for romantic occasions. 12 stems of premium quality roses.',
                price: 150000,
                currency: 'UZS',
        ...
        prisma.product.create({
            data: {
                title: 'White Tulips',
                slug: 'white-tulips',
                description: 'Fresh white tulips, perfect for weddings and special events. 20 stems.',
                price: 120000,
                currency: 'UZS',
        ...
        prisma.product.create({
            data: {
                ...
                description: 'Colorful mixed flower bouquet with roses, tulips, and baby breath. Perfect gift.',
                price: 200000,
                currency: 'UZS',
        ...
        prisma.product.create({
            data: {
                title: 'Pink Orchids',
                slug: 'pink-orchids',
                description: 'Exotic pink orchids in elegant pot. Perfect for home decoration.',
                price: 180000,
                currency: 'UZS',
        ...
        prisma.product.create({
            data: {
                title: 'Yellow Roses',
                slug: 'yellow-roses',
                description: 'Bright yellow roses, symbol of friendship and joy. 15 stems.',
                price: 140000,
                currency: 'UZS',
                categoryId: rosesCategory.id,
        ...
        prisma.product.create({
            data: {
                ...
                description: 'Elegant wedding flower arrangement with white roses and eucalyptus. Perfect for ceremonies.',
                price: 350000,
                currency: 'UZS',
                categoryId: bouquetsCategory.id,
        ...
        prisma.product.create({
            data: {
                ...
                description: 'Set of 3 beautiful indoor plants: Monstera, Fiddle Leaf Fig, and Snake Plant.',
                price: 250000,
                currency: 'UZS',
    ...
    const reviews = await Promise.all([
        prisma.review.create({
            data: {
                ...
                orderId: orders[0].id,
                rating: 5,
                comment: 'Excellent quality roses! Very fresh and beautiful. Highly recommended!',
                isVerified: true,
                helpfulCount: 3,
