...
class TopUpDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { amount: { required: true, type: () => Number, minimum: 1000 }, method: { required: true, type: () => Object }, gateway: { required: false, type: () => Object } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)({
        example: 30000,
        description: 'Amount to top up in UZS',
        minimum: 1000,
    }),
...
__decorate([
    ...
    __metadata("design:type", String)
], TopUpDto.prototype, "gateway", void 0);
