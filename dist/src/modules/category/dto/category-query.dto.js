...
class CategoryQueryDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { search: { required: false, type: () => String }, isActive: { required: false, type: () => Boolean }, parentId: { required: false, type: () => String }, includeChildren: { required: false, type: () => Boolean, default: false }, page: { required: false, type: () => Number, default: 1, minimum: 1 }, limit: { required: false, type: () => Number, default: 20, minimum: 1 } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CategoryQueryDto.prototype, "includeChildren", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
