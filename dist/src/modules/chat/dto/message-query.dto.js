...
class MessageQueryDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { page: { required: false, type: () => Number, default: 1 }, limit: { required: false, type: () => Number, default: 50 }, cursor: { required: false, type: () => String, format: "uuid" } };
    }
}
...
], MessageQueryDto.prototype, "cursor", void 0);
