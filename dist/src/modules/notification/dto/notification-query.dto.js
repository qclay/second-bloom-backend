...
class NotificationQueryDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { page: { required: false, type: () => Number, default: 1, minimum: 1 }, limit: { required: false, type: () => Number, default: 20, minimum: 1 }, type: { required: false, type: () => Object }, isRead: { required: false, type: () => Boolean }, sortBy: { required: false, type: () => Object, default: "createdAt" }, sortOrder: { required: false, type: () => Object, default: "desc" } };
    }
}
